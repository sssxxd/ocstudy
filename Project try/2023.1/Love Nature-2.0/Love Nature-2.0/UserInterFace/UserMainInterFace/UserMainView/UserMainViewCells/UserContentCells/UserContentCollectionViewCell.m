//
//  UserContentCollectionViewCell.m
//  Find
//
...
@interface UserContentCollectionViewCell ()
...
@implementation UserContentCollectionViewCell {
    CGFloat _iconWidth;
}
...
- (void) layoutIfNeeded {
    ...
    _mainImageView.image = [UIImage imageNamed:_contentDataModel.mainImage];
    _userIconImageView.image = [UIImage imageNamed:_contentDataModel.userIcon];
    _userNameLabel.text = _contentDataModel.userName;
    _titleLabel.text = _contentDataModel.title;
