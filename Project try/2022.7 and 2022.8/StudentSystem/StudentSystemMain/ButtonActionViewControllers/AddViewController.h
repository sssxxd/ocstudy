...
@property (nonatomic, strong) NSMutableSet* studentNumber;

@property (nonatomic, strong) UIImageView* backImageView;

@property (nonatomic, strong) UITextField* studentNameTextDield;
@property (nonatomic, strong) UITextField* studentNumberTextField;
